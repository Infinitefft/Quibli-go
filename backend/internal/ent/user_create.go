...
func (uc *UserCreate) AddLikePostIDs(ids ...int) *UserCreate {
	uc.mutation.AddLikePostIDs(ids...)
	return uc
}

// AddLikePosts adds the "like_posts" edges to the UserLikePost entity.
func (uc *UserCreate) AddLikePosts(u ...*UserLikePost) *UserCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uc.AddLikePostIDs(ids...)
}

// AddLikeQuestionIDs adds the "like_questions" edge to the UserLikeQuestion entity by IDs.
func (uc *UserCreate) AddLikeQuestionIDs(ids ...int) *UserCreate {
	uc.mutation.AddLikeQuestionIDs(ids...)
	return uc
}

// AddLikeQuestions adds the "like_questions" edges to the UserLikeQuestion entity.
func (uc *UserCreate) AddLikeQuestions(u ...*UserLikeQuestion) *UserCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uc.AddLikeQuestionIDs(ids...)
}
...
func (uc *UserCreate) AddFavoritePosts(u ...*UserFavoritePost) *UserCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (uc *UserCreate) AddFavoriteQuestionIDs(ids ...int) *UserCreate {
	uc.mutation.AddFavoriteQuestionIDs(ids...)
	return uc
}

// AddFavoriteQuestions adds the "favorite_questions" edges to the UserFavoriteQuestion entity.
func (uc *UserCreate) AddFavoriteQuestions(u ...*UserFavoriteQuestion) *UserCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uc.AddFavoriteQuestionIDs(ids...)
}
...
func (uc *UserCreate) AddFollowing(f ...*Follow) *UserCreate {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
...
func (uc *UserCreate) AddFollowedBy(f ...*Follow) *UserCreate {
	ids := make([]int, len(f))
	for i := range f {
		ids[i] = f[i].ID
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.LikePostsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := uc.mutation.LikeQuestionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := uc.mutation.FavoriteQuestionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
