...
// The UserFavoritePostFunc type is an adapter to allow the use of ordinary
// function as UserFavoritePost mutator.
type UserFavoritePostFunc func(context.Context, *ent.UserFavoritePostMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserFavoritePostFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserFavoritePostMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserFavoritePostMutation", m)
}

// The UserFavoriteQuestionFunc type is an adapter to allow the use of ordinary
// function as UserFavoriteQuestion mutator.
type UserFavoriteQuestionFunc func(context.Context, *ent.UserFavoriteQuestionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserFavoriteQuestionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserFavoriteQuestionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserFavoriteQuestionMutation", m)
}

// The UserLikePostFunc type is an adapter to allow the use of ordinary
// function as UserLikePost mutator.
type UserLikePostFunc func(context.Context, *ent.UserLikePostMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserLikePostFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserLikePostMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserLikePostMutation", m)
}

// The UserLikeQuestionFunc type is an adapter to allow the use of ordinary
// function as UserLikeQuestion mutator.
type UserLikeQuestionFunc func(context.Context, *ent.UserLikeQuestionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserLikeQuestionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserLikeQuestionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserLikeQuestionMutation", m)
}
